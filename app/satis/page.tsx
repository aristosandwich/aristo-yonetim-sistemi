    ...
    try {
      ...
      if (
        ...
        const birlestirilmis =
          varsayilanAdisyonlar.map(
            (varsayilan) => {
              const bulunan =
                kayitliAdisyonlar.find(
                  (kayit) =>
                    kayit.id ===
                    varsayilan.id
                );
